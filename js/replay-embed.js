...
linkStyle('https://crunchy-league.herokuapp.com/style/font-awesome.css?');
linkStyle('https://crunchy-league.herokuapp.com/style/battle.css?a7');
linkStyle('https://crunchy-league.herokuapp.com/style/replay.css?a7');
linkStyle('https://crunchy-league.herokuapp.com/style/utilichart.css?a7');

requireScript('https://crunchy-league.herokuapp.com/js/lib/ps-polyfill.js');
requireScript('https://crunchy-league.herokuapp.com/config/config.js?a7');
requireScript('https://crunchy-league.herokuapp.com/js/lib/jquery-1.11.0.min.js');
requireScript('https://crunchy-league.herokuapp.com/js/lib/lodash.compat.js');
requireScript('https://crunchy-league.herokuapp.com/js/lib/html-sanitizer-minified.js');
requireScript('https://crunchy-league.herokuapp.com/js/battle-sound.js');
requireScript('https://crunchy-league.herokuapp.com/js/battledata.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/pokedex-mini.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/pokedex-mini-bw.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/graphics.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/pokedex.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/moves.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/abilities.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/items.js?a7');
requireScript('https://crunchy-league.herokuapp.com/data/teambuilder-tables.js?a7');
requireScript('https://crunchy-league.herokuapp.com/js/battle-tooltips.js?a7');
requireScript('https://crunchy-league.herokuapp.com/js/battle.js?a7');
