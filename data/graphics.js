...
BattleMoveAnims['soulsuck']={anim:BattleMoveAnims['neverendingnightmare'].anim};
BattleMoveAnims['fierydarts']={anim:BattleMoveAnims['flameburst'].anim};
BattleMoveAnims['nuclearbreath']={anim:BattleMoveAnims['dragonbreath'].anim};
BattleMoveAnims['radiationburst']={anim:BattleMoveAnims['diamondstorm'].anim};
BattleMoveAnims['radiationbeam']={anim:BattleMoveAnims['futuresight'].anim};
BattleMoveAnims['falloutslam']={anim:BattleMoveAnims['breakneckblitz'].anim};
BattleMoveAnims['radioactivedecayalpha']={anim:BattleMoveAnims['hyperbeam'].anim};
BattleMoveAnims['radioactivedecaybeta']={anim:BattleMoveAnims['technoblast'].anim};
